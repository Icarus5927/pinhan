<template>
  <div>
        ...
        <el-tabs type="border-card" v-model="activeName">
          <el-tab-pane :label="item" v-for="(item,index) in label" :key="index" :name="item">
            ...
            <el-table :data="list" stripe border
                      v-show="activeName === 'A辅' || activeName === 'B辅' || activeName === 'C辅'">
              <el-table-column type="index" label="#">
              </el-table-column>
              <el-table-column v-for="(item,index) in headerABC" :key="index" :prop="item.prop" :label="item.label"
                               :width="item.width">
              </el-table-column>
            ...
            <el-table :data="list" stripe border v-show="activeName === '一对一'">
              ...
              <el-table-column v-for="(item,index) in header121" :key="index" :prop="item.prop" :label="item.label"
                               :width="item.width">
              </el-table-column>
              <el-table-column label="操作" width="150px">
                <template slot-scope="scope">
            ...
            <el-table :data="list" stripe border v-show="activeName === '班课'">
              ...
              <el-table-column v-show="activeName === '班课'" v-for="(item,index) in headerClassCourse" :key="index"
    ...
    <el-dialog :title="title" :visible.sync="dialogVisible" width="40%" :show-close="false" @close="onreset()">
      <div>
        <el-form v-show="activeName === 'A辅'|| activeName === 'B辅' || activeName === 'C辅'" ref="form" label-width="90px"
