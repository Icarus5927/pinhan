                ...
                <el-tabs type="border-card" v-model="activeName">
                    <el-tab-pane :label="item" v-for="(item,index) in label" :key="index" :name="item">
                        ...
                        <el-table :data="list" stripe border>
                            ...
                            <el-table-column v-for="(item,index) in studentList" :key="index" :prop="item.prop" :label="item.label" :width="item.width">
                            </el-table-column>
                            <el-table-column v-for="index of 31" :prop="'date'+index" :label="index+''" width="29px" :key="index+'1'">
                            </el-table-column>
                            <el-table-column label="操作">
                                <template slot-scope="scope">
                                    <el-button type="primary" size="mini" @click="uploadd(scope.row)">提交</el-button>
...
export default {
    ...
    data() {
        return {
            ...
            label: ["A辅", "B辅", "一对一", "班课"],
            studentList: [
                { prop: "work_id", label: "姓名", width: "94px" },
                { prop: "name", label: "辅导科目", width: "94px" }
            ],
            // form: {},
            list: [
                {
